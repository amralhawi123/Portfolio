    ...
    <div className='portfolio text-center'>  
      ...
      <div className='box gap-3 mt-5'>
         <Row>
            ...
            <Card>
      <Card.Img variant="top" src={ecommerce} style={{height:"250px"}} className='hov-trans'/>
      <Card.Body className='d-flex algin-items-center gap-3 justify-content-center'>
        ...
        <Card.Text>
          <i class='fa-solid fa-arrow-up-right-from-square'></i>
            ...
            <Card>
      <Card.Img variant="top" src={linked} style={{height:"250px"}} className='hov-trans'/>
      <Card.Body className='d-flex algin-items-center gap-3 justify-content-center'>
      ...
      <Card.Body className='d-flex algin-items-center gap-3 justify-content-center'>
        ...
        <Card.Text>
          <i class='fa-solid fa-arrow-up-right-from-square'></i>
            ...
            <Card>
      <Card.Img variant="top" src={auth} style={{height:"250px"}}/>
      <Card.Body className='d-flex algin-items-center gap-3 justify-content-center'>
